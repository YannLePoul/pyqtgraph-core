...
class Circle(GraphicsObject):
    ...
    **Bases:** :class:`GraphicsObject <pyqtgraph.GraphicsObject>`
    ...
    Displays a circle.
    This circle may be dragged to indicate a position in data coordinates.
    ...
    **Signals:**
    ...
    def __init__(self, pos=None, radius=90, pen=None, movable=False):
        """
        =============== ==================================================================
        **Arguments:**
        pos             Position of the circle. This can be a QPointF.
        radius          radius of the circle.
        pen             Pen to use when drawing circle. Can be any arguments that are valid
    ...
    def setRadius(self, radius):
        ...
        Note that the use of radius() and setradius() changes if the line is 
        not vertical or horizontal.
        """
        self.radius = ((angle + 45) % 180) - 45  ##  -45 <= angle < 135
        self.update()
    ...
    def radius(self):
        """Return the radius of the line. Will be a single number for horizontal and 
        vertical lines, and a list of [x,y] radiuss for diagonal lines."""
        if self.angle % 180 == 0:
            return self.getYPos()
    ...
    def setradius(self, v):
        ...
        a single radius. Otherwise, a 2D coordinate must be specified (list, tuple and 
